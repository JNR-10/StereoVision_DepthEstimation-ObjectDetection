...
class Feature(SubModule):
    def __init__(self):
        ...
        # instead of assuming the presence of internals like act1/blocks which
        # vary between timm versions and backbone choices.
        pretrained = True
        self.backbone = timm.create_model('mobilenetv2_100', pretrained=pretrained, features_only=True)
        # Project backbone feature maps to expected channel sizes used by the
